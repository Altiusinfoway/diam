<!--jquery min js-->
<script src="{{ staticAsset('frontend/main/js/vendor/jquery-3.4.1.min.js') }}"></script>
<script src="{{ staticAsset('frontend/main/js/popper.js') }}"></script>
<script src="{{ staticAsset('frontend/main/js/bootstrap.min.js') }}"></script>
<script src="{{ staticAsset('frontend/main/js/plugins.js') }}"></script>
<script src="{{ staticAsset('frontend/main/js/owl.carousel.main.js') }}"></script>
<script src="{{ staticAsset('frontend/main/js/jquery.nice.select.js') }}"></script>
<script src="{{ staticAsset('frontend/main/js/scrollup.js') }}"></script>
<script src="{{ staticAsset('frontend/main/js/ajax.chimp.js') }}"></script>
<script src="{{ staticAsset('frontend/main/js/jquery.ui.js') }}"></script>
<script src="{{ staticAsset('frontend/main/js/jquery.elevatezoom.js') }}"></script>
<script src="{{ staticAsset('frontend/main/js/imagesloaded.js') }}"></script>
<script src="{{ staticAsset('frontend/main/js/isotope.main.js') }}"></script>
<script src="{{ staticAsset('frontend/main/js/jqquery.ripples.js') }}"></script>
<script src="{{ staticAsset('frontend/main/js/jquery.cookie.js') }}"></script>
<script src="{{ staticAsset('frontend/main/js/bpopup.js') }}"></script>
<script src='https://cdn.jsdelivr.net/npm/x-mega-menu@1.4.1/dist/x-mega-menu.min.js'></script>
<!-- Main JS -->
<script src="{{ staticAsset('frontend/main/js/main.js') }}"></script>
...
document.addEventListener('DOMContentLoaded', function() {
        xMegaMenu('#mega-menu', {
            ...
            blurEffect: false,
            disableLinks: false,
            fixedTop: false, // Ensure fixed top is disabled
