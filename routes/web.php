...
Route::post('/products/show-product-info', [ProductController::class, 'showInfo'])->name('products.template');
Route::any('/iyzico/payment/callback', [IyZicoController::class, 'callback'])->name('products.showInfo');
